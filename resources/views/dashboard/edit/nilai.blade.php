  ...
  <div class="col row justify-content-center">
    <div class="card border-0 col-lg-6 col-md-8">
      <div class="card-body px-lg-13 py-lg-5">
        ...
        <form role="form" action="/update-nilai-{{ $nilais->id }}" method="POST">
          @method('put')
          @csrf
          <div class="form-group">
              <label class="form-control-label" for="input-username">Nilai Presentasi</label>
              <input class="form-control @error('nilai_presentasi') is-invalid @enderror" type="number" step="0.01" name="nilai_presentasi" value="{{ old('nilai_presentasi',$nilais->nilai_presentasi) }}" required>
          ...
          <div class="form-group">
              ...
              <input class="form-control @error('nilai_buku_proposal') is-invalid @enderror" type="number" step="0.01" name="nilai_buku_proposal" value="{{ old('nilai_buku_proposal',$nilais->nilai_buku_proposal) }}" required>
          ...
          <div class="form-group">
              ...
              <input class="form-control @error('nilai_ide_inovasi_proposal') is-invalid @enderror" type="number" step="0.01" name="nilai_ide_inovasi_proposal" value="{{ old('nilai_ide_inovasi_proposal',$nilais->nilai_ide_inovasi_proposal) }}" required>
